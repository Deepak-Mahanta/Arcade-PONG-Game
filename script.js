...
let paddle1Y = 95;
let paddle2Speed = 0;
let paddle2Y = 95; //Paddle top value
let ballX = 209;
let ballSpeedX = 2;
let ballY = 190;
let ballSpeedY = 2;
...
const paddleDecelareration = 1;
const gameHeight = 255;
const gameWidth = 400;
...
function updatePaddle1() {
  if (keysPressed["w"]) {
    ...
    if (paddle1Speed > 0) {
      paddle1Speed = Math.max(paddle1Speed - paddleDecelareration, 0);
    } else if (paddle1Speed < 0) {
      paddle1Speed = Math.min(paddle1Speed + paddleDecelareration, 0);
    }
  }
...
function updatePaddle2() {
  if (keysPressed["ArrowUp"]) {
    ...
    if (paddle2Speed > 0) {
      paddle2Speed = Math.max(paddle2Speed - paddleDecelareration, 0);
    } else if (paddle2Speed < 0) {
      paddle2Speed = Math.min(paddle2Speed + paddleDecelareration, 0);
    }
  }
